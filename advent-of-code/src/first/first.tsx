  ...
  return (
    <div className='First card-body'>
      ...
      <p className='card-text'>
        The max calories is {topThreeCals[0]}.
      </p>
      <p className='card-text'>
        The top three are: {topThreeCals[0]}, {topThreeCals[1]}, and {topThreeCals[2]}. 
      </p>
      <p className='card-text'>
        The sum of the top three is: {topThreeCals[0] + topThreeCals[1] + topThreeCals[2]}. 
      </p>
    </div>
  );
}
